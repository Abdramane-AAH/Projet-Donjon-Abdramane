...
public class Playground {
    ...
    public Playground(String pathName) {
        try {
            ...
            final Image imageTrap = ImageIO.read(new File("./img/trap_on_grass.png"));
            ...
            final int trapWidth = imageTrap.getWidth(null);
            final int trapHeight = imageTrap.getHeight(null);
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)) {
                    switch (element) {
                        ...
                        case 'R':
                            ...
                            break;
                        case 'P':  // Ajout du piège
                            environment.add(new Trap(columnNumber * trapWidth,
                                    lineNumber * trapHeight, imageTrap, trapWidth, trapHeight));
                            break;
                    }
                    columnNumber++;
                }
